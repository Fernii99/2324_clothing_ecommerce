      ...
      <div className="h-[80vh] ">
        ...
        <div className="flex w-full justify-center align-center h-full  mt-8">
          <div className="flex flex-row w-4/6 h-96 bg-primary justify-between align-center mt-10"> 
            <div className="flex w-4/6 -ml-16 justify-center align-center flex-col  ">
              <h1 className="mb-3  text-6xl font-bold sm:text-5xl md:mb-8 md:text-7xl">
                L`AEG Boutique
              </h1>
              <p className=" leading-relaxed text-white xl:text-xl">
